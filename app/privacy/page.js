      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <section className="space-y-4">
          ...
          <p className="leading-relaxed">
            Welcome to <strong>NisargJayeshDelvadiya</strong> (accessible via <a href="https://www.nisargjayeshdelvadiya.in" className="text-blue-400 hover:underline">www.nisargjayeshdelvadiya.in</a>). We respect your privacy and are committed to protecting your personal data. 
          </p>
          <p className="leading-relaxed">
